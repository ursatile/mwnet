...
namespace Rockaway.WebApp.Areas.MyArea {
	[Area("MyArea")]
	public class VenuesController : Controller {
		...
		// GET: MyArea/Venues/Create
		public IActionResult Create() {
			return View();
		}

		// POST: MyArea/Venues/Create
